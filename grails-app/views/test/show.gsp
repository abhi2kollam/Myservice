	...
	<body>
		...
		<div id="show-test" class="content scaffold-show" role="main">
			...
			<ol class="property-list test">
				...
				<g:if test="${testInstance?.value}">
				<li class="fieldcontain">
					<span id="value-label" class="property-label"><g:message code="test.value.label" default="Value" /></span>
					
						<span class="property-value" aria-labelledby="value-label"><g:fieldValue bean="${testInstance}" field="value"/></span>
